...
- **Komplett-Backup**: Über die Fusszeile lassen sich alle Daten (Klassen, Wochenpläne, Anwesenheitsdaten, Teilnehmerliste) als JSON sichern — **optional mit Passwort verschlüsselt** (AES-GCM) — und auf einem anderen Gerät/Browser wiederherstellen.
