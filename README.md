...
- **Punkte-Tracker (Bonusstunden)**: Pro Klasse aktivierbar (beim Anlegen oder in der Detailansicht). Pro Lektion werden erfüllte Ziele abgehakt (z.B. "Alle starten sofort", "Fairplay") — jedes Ziel gibt wahlweise **1 oder 2 Punkte**, die Ziele sind frei anpassbar. Der Punktestand summiert sich über die Lektionen; über "Punkte einlösen" wird er (z.B. für eine Bonusstunde) auf 0 zurückgesetzt, der Verlauf bleibt nachvollziehbar. Lektionen können Bemerkungen tragen und nachträglich gelöscht werden.
