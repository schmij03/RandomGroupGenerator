...
- **Auswertung**: Pro Klasse eine Übersicht mit Anwesenheits-/Abwesenheitszahlen, Anwesenheitsquote und Aufschlüsselung der Abwesenheitsgründe je Schüler(in) – inkl. CSV-Export. Lässt sich nach **Semester 1 (Aug–Jan) oder Semester 2 (Feb–Jul)** filtern oder für das ganze Schuljahr anzeigen; das Semester wird automatisch anhand des Termindatums bestimmt.
